...
<div class="shareAPIPolyfill-header">
 <div class="shareAPIPolyfill-header-title" tabindex="0">${icon.share} ${
          language.shareTitle
        }</div>
...
<div class="shareAPIPolyfill-body">
 <div class="shareAPIPolyfill-icons-container body">
  ...
  } tool-icon skype skype-share" data-tool="skype" data-href="${url}" data-text="${
          title + ": " + url
        }">
   ${icon.skype}
...
`;
        ...
        function bindEvents() {
          Array.from(container.querySelectorAll(".tool-icon")).forEach(
            (tool) => {
              tool.addEventListener("click", (event) => {
                ...
                switch (tool.dataset.tool) {
                  ...
                  case "sms": {
                    location.href = `sms:${
                      language.selectSms
                    }?&body=${encodeURIComponent(title)}: ${encodeURIComponent(
                      data.text || ""
                    )} ${url}`;
                    break;
                  }
                  ...
                  case "twitter": {
                    window.open(
                      `https://twitter.com/intent/tweet?text=${encodeURIComponent(
                        text
                      )}&url=${encodeURIComponent(url)}&hashtags=${
                        hashtags || ""
